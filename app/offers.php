      ...
      <table class="stat">
        <thead>
          <tr>
            ...
            <th>Статус<br>оффера&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
            <th>Ставка&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
            <th>За что<br>платим&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
            <th>Партнерская ссылка&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
            <th>Материалы&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
            <th>Менеджер&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>50%</td>
            <td>сделка</td>
            <td class="link"><a href="#">https://my.synergy.ru/partner/</a></td>
            <td class="link"><a href="#">ссылка</a></td>
            <td class="product">Иван Иванов<br><span>+71000000000</span></td>
          </tr>
          <tr>
            <td>1.</td>
            <td class="product">Трансформация<br><span>(базовый)</span></td>
