  ...
  <section id="profile">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <div class="user-side">
            <button type="button" class="user-side__avatar">
              <img src="img/avatar.png" alt="" class="img-fluid">
              <div class="user-side__end"><img src="img/photo.png" alt=""></div>
            </button>
        ...
        <div class="col-md-8 profile">
          ...
          <form action="" method="post" class="profile-form">
            <div class="profile-form__group">
              ...
              <input type="text" name="login" value="Oblomov">
            </div>
            <div class="profile-form__group">
              <label for="name">Имя</label>
              <input type="text" name="name" value="Илья">
            </div>
            <div class="profile-form__group">
              <label for="secondname">Фамилия</label>
              <input type="text" name="secondname" value="Обломов">
            </div>
            <div class="profile-form__group">
              ...
              <div id="borndate">
                ...
                <select name="month">
                  ...
                  <option value="Октябрь" selected>Октябрь</option>
          ...
          <form action="" method="post" class="profile-form">
            <div class="profile-form__group">
              ...
              <input type="password" name="oldpassword" value="123456">
            </div>
            <div class="profile-form__group">
            ...
            <div class="profile-form__group">
              <label for="newpasswordagain">Подтвердите пароль</label>
              <input type="password" name="newpasswordagain" value="">
            </div>
            <div class="profile-form__group">
              <label for=""></label>
              <a href="#"></a>
