  ...
  <section id="howitwork">
    <div class="container">
      ...
      <div class="row howitwork">
        <div class="howitwork__item">Отслеживайте статистику по реализованным продуктам в Личном кабинете</div>
        <div class="howitwork__item">Выберите период, обговоренный с менеджером, за который необходимо получить вознаграждение, перенесите данные в Акт и отправьте менеджеру</div>
        <div class="howitwork__item">Получите вознаграждение — 50% с каждой транзакции</div>
      </div>
    </div>
  </section>
