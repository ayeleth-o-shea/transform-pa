...
<body>
  ...
  <div class="container">
    ...
    <span style="color: #000; margin: 30px 20px 30px 0;text-transform: none;">< Навигация для теста, на проде убираем.</>
  </div>
  <header>
    <div class="container">
      ...
      <div class="row">
        <div class="modul active">
          ...
          <div class="modul__center">
            ...
            <div class="modul__value">
              <span>0</span> / 100 <br>баллов
            </div>
          </div>
